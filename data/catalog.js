...
const VEHICLES = [
  ["Toyota", "Land Cruser", 170000], ["Kia", "K5", 120000], ["Hyundai", "Sonata", 140000], ["Volkswagen", "Tiguan", 150000], ["Toyota", "Camry", 160000],
  ["BMW", "3 Series", 200000], ["Mercedes-Benz", "C-Class", 7"200000], ["Audi", "A6", 200000], ["BMW", "5 Series", 250000], ["Mercedes-Benz", "E-Class", 250000],
  ["Audi", "Q5", 250000], ["BMW", "X5M", 300000], ["Mercedes-Benz", "GLE", 300000], ["Land Rover", "Range Rover Sport", 300000], ["Porsche", "Cayenne 2024", 300000],
  ["BMW", "X7", 350000], ["Mercedes-Benz", "S-Class", 350000], ["Mercedes-Benz", "G-Class", 350000], ["Porsche", "911 Carrera", 350000], ["BMW", "M5 F90", 350000]
].map(([brand, model, price], i) => ({ id: `hm_${i + 1}`, brand, model, price, category: "Heavy Motors" }));

const EXCLUSIVE = [
  ["Mercedes-Benz", "S 580", 320000, "AMG"], ["BMW", "M8 Competition", 340000, "Motorsport"], ["Audi", "RS Q8 ", 330000, "CARBONE"], ["Porsche", "911 Turbo S Mansory", 430000, "MANSORY"],
  ["BMW", "X7 M60i Mansory", 480000, "MANSORY"], ["Mercedes-Benz", "G 63 BRABUS", 520000, "BRABUS"], ["Mercedes-Benz", "S 580 BRABUS", 500000, "BRABUS"],
  ["Porsche", "Cayenne Turbo GT", 460000, "stock"], ["Audi", "RS 7 Full-Carbone", 390000, "CARBONE"], ["BMW", "XM Label Alpina", 410000, "ALPINA"], ["Mercedes-Benz", "Maybach S 680", 560000, "AMG"],
  ["Porsche", "911 GT3 RS", 590000, "stock"], ["Mercedes-Benz", "220 TechArt", 720000, "TechArt"], ["Ferrari", "296 GTB", 760000,], ["Lamborghini", "Huracan Tecnica Novitec", 780000, "NOVITEC"]
...
const PROPERTY = [
  ...
  ["absolute_penthouse", "Absolute Penthouse", "Absolute", 320000], ["absolute_sea", "Penthouse у моря", "Absolute", 390000], ["legend_mansion", "Загородный дом", "Legend", 520000],
  ["legend_estate", "Legend Estate", "Legend", 680000], ["legend_palace", "Пентхаус", "Legend", 850000], ["brutal_residence", "Особняк", "Brutal", 1100000],
  ["brutal_villa", "Вилла", "Brutal", 1450000], ["brutal_palace", "Дворец", "Brutal", 1900000]
...
const BEAUTIFUL_NUMBERS = [
  "А222АА77","А333АА77","А444АА77","А555АА77","А666АА77","А888АА77","А999АА77","У111УУ77",
