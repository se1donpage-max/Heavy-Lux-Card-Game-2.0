...
const SUIT_NAMES = Object.freeze({ "♠": "Пики", "♥": "Червы", "♦": "Бубны", "♣": "Трефы" });
const RANKS = Object.freeze([6, 7, 8, 9, 10, "J", "Q", "K", "A"]);
const VALUES = Object.freeze({ 6: 6, 7: 7, 8: 8, 9: 9, 10: 10, J: 11, Q: 12, K: 13, A: 14 });
...
module.exports = { SUITS, SUIT_NAMES, RANKS, VALUES, createDeck, shuffle, canBeat };
